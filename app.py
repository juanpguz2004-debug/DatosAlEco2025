...
def load_data(file_path):
    try:
        ...
        # Lógica de limpieza sincronizada con la Celda de Código <KMjfoiIVDQRe> del Notebook:
        for col in numeric_cols:
             ...
             s = (
                 ...
                 .str.replace(',', '', regex=False) # CRÍTICO: Remueve la coma (miles o decimal), sincronizado con el notebook
...
with col_sel_year:
    ...
    # Asegurarse de que el año de predicción sea mayor que el año de corte de la empresa
    if ano_corte_mas_reciente_global:
        años_futuros = [y for y in pred_years if y > ano_corte_mas_reciente_global]
    else:
        años_futuros = pred_years # Usar todos si el año de corte no se pudo determinar
...
try:
    ...
    # Nota: Si el dashboard muestra números incorrectos (demasiado grandes o pequeños), 
    # es probable que necesites (o no) una línea de escalado aquí, dependiendo de si 
    # escalaste en tu notebook (ej: ganancia_anterior = ganancia_anterior / 100.0).
